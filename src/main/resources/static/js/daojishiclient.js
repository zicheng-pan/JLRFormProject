...
function connect() {
    ...
    stompClient.connect({}, function (frame) {
        ...
        stompClient.subscribe('/countdownnumber', function (result) {
            countdownFrom = result.body;
            drawwithWebSocket(countdownFrom);
        });
    });
}
...
function init() {
    ...
    stageCtx = stage.getContext('2d', {willReadFrequently: true});
